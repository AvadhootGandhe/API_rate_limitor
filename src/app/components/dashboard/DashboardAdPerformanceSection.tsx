...
export function DashboardAdPerformanceSection() {
  ...
  return (
    <section id="ad-performance" className="space-y-6 scroll-mt-24">
      <div>
        <h2 className="text-xl font-semibold text-gray-900">Ad performance</h2>
        <p className="text-sm text-gray-600 mt-1">Impressions, CTR, CPC, and conversions over time.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data.cpcTrend}>
              ...
              <Tooltip
                ...
                formatter={(value: number) => [`$${value}`, 'CPC']}
              />
              <Line
                type="monotone"
                dataKey="cpc"
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 lg:col-span-2 shadow-sm">
